...
public class OrdersController {
	...
	public ResponseEntity<?> addOrder(@RequestBody Orders order){
		...
		order.setId(sequenceGeneratorService.generateSequence(Orders.SEQUENCE_NAME));
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateOrdersById(@RequestBody Orders order, @PathVariable int id){
